...
export function IconMulti(props) {
    const { stroke, fill, number, iconsList } = props
    ...
    return (
        <Frame background="none" size="100%">
            <SvgWrapper>{parse(iconsList[number].path)}</SvgWrapper>
        </Frame>
    )
}

IconMulti.defaultProps = {
    height: 24,
    width: 24,
}

addPropertyControls(IconMulti, {
    stroke: {
        title: "Stroke",
    ...
    iconsList: {
        ...
        control: {
            ...
            controls: {
                name: { type: ControlType.String, defaultValue: "Name" },
                path: {
                    title: "SVG",
        ...
        defaultValue: [
            {
                title: "Framer",
                path: `<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0)"><path d="M5.28075 16.8435H12.2807M5.28075 16.8435V9.84353H19.2807V2.84353H5.28075L19.2807 16.8435H12.2807H5.28075ZM5.28075 16.8435L12.2807 23.8435V16.8435H5.28075Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0"><rect width="24" height="24" fill="white" transform="translate(0.280746 0.843529)"/></clipPath></defs></svg>`,
            },
            {
                title: "Figma",
